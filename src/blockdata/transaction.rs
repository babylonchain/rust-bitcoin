...
use crate::blockdata::locktime::{Height, LockTime, PackedLockTime, Time};
...
use crate::internal_macros::{
    impl_consensus_encoding, serde_string_impl, serde_struct_human_string_impl, write_err,
};
...
impl Sequence {
    ...
    #[inline]
    pub fn is_final(&self) -> bool { *self == Sequence::MAX }
    ...
    #[inline]
    pub fn enables_absolute_lock_time(&self) -> bool { !self.is_final() }
...
impl Default for TxOut {
    fn default() -> TxOut { TxOut { value: 0xffffffffffffffff, script_pubkey: Script::new() } }
}
...
impl Transaction {
    ...
    pub fn encode_signing_data_to<Write: io::Write, U: Into<u32>>(
        ...
        EncodeSigningDataResult::WriteResult(encode_signing_data_to_inner(
            self,
            writer,
            input_index,
            script_pubkey,
